...
class InsertIbuprofenRelDataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        return {
            ...
            'train': self._generate_examples(path='/home/febert/data/closed_loop_demos/insert_ibuprofen_relactions/*/*/*.hdf5'),
        }
    ...
    def _generate_examples(self, path) -> Iterator[Tuple[str, Any]]:
        ...
        def _parse_example(episode_path):
            ...
            with h5py.File(episode_path, 'r') as root:
                ...
                qpos = np.array(root['observations']['robot_poses'])
